...
function getSetFromName(name) {
	switch(name){
		...
		case "Criminal":
			return new criminal();
		case "Cupid and Eris":
			return new cupidAndEris();
		case "Dealer":
			return new dealer();
		case "Demon":
			return new demon();
		case "Dr. Boom and Tuesday Knight":
			return new drBoomAndTuesdayKnight();
		case "Enforcer":
			return new enforcer();
		case "Invincible":
...
function core() {
	var set = {
		name: "Core Set",
		cards: ["President", "Bomber", "Blue Team", "Red Team"],
		winCon: "location",
...
function anarchist() {
	var set = {
		...
		cards: ["Anarchist"],
		winCon: "passFail",
		prompt: "Hey Anarchist, were you part of a usurping a majority of the rounds?",
		options: ["Yes", "No"],
		calculateWinners: function(answer, winnersArray, losersArray) {
			if(answer === "Yes") {
...
function drunk() {
	var set = {
		...
		calculateWinners: function(answer, winnersArray, losersArray) {
			if(answer === "Yes") {
				//do nothing. Drunk will be the "sober" card that was set aside at the beginning of the game.
			}
			else {
...
function ambassador() {
	var set = {
		name: "Ambassador",
		cards: ["Blue Ambassador", "Red Ambassador"],
		winCon: "basic",
	}
	return set;
}
...
function bouncer() {
	var set = {
		name: "Bouncer",
		cards: ["Blue Bouncer", "Red Bouncer"],
		winCon: "basic",
	}
	return set;
}
...
function criminal() {
	var set = {
		name: "Criminal",
		cards: ["Blue Criminal", "Red Criminal"],
		winCon: "basic",
	}
	return set;
}

function cupidAndEris() {
	var set = {
		name: "Cupid and Eris",
		cards: ["Cupid", "Eris"],
		winCon: "basic",
...
function demon() {
	var set = {
		name: "Demon",
		cards: ["Blue Demon", "Red Demon"],
		winCon: "basic",
	}
	return set;
}

function drBoomAndTuesdayKnight() {
	var set = {
		name: "Dr. Boom and Tuesday Knight",
		cards: ["Dr. Boom", "Tuesday Knight"],
		winCon: "basic",
	}
	return set;
}
...
function enforcer() {
	var set = {
		name: "Enforcer",
		cards: ["Blue Enforcer", "Red Enforcer"],
		winCon: "basic",
	}
	return set;
}
...
function invincible() {
	var set = {
		name: "Invincible",
		cards: ["Blue Invincible", "Red Invincible"],
		winCon: "basic",
	}
	return set;
}
...
function negotiator() {
	var set = {
		name: "Negotiator",
		cards: ["Blue Negotiator", "Red Negotiator"],
		winCon: "basic",
	}
	return set;
}
...
function paparazzo() {
	var set = {
		name: "Paparazzo",
		cards: ["Blue Paparazzo", "Red Paparazzo"],
		winCon: "basic",
	}
	return set;
}
...
function paranoid() {
	var set = {
		name: "Paranoid",
		cards: ["Blue Paranoid", "Red Paranoid"],
		winCon: "basic",
	}
	return set;
}
...
function psychologist() {
	var set = {
		name: "Psychologist",
		cards: ["Blue Psychologist", "Red Psychologist"],
		winCon: "basic",
	}
	return set;
}
...
function security() {
	var set = {
		name: "Security",
		cards: ["Blue Security", "Red Security"],
		winCon: "basic",
	}
	return set;
}
...
function shyGuy() {
	var set = {
		name: "Shy Guy",
		cards: ["Blue Shy Guy", "Red Shy Guy"],
		winCon: "basic",
	}
	return set;
}
...
function usurper() {
	var set = {
		name: "Usurper",
		cards: ["Blue Usurper", "Red Usurper"],
		winCon: "basic",
	}
	return set;
}